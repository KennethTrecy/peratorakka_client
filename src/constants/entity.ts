...
export const normalDebitAccountKinds = [
	GENERAL_ASSET_ACCOUNT_KIND,
	GENERAL_EXPENSE_ACCOUNT_KIND,
	LIQUID_ASSET_ACCOUNT_KIND,
	DEPRECIATIVE_ASSET_ACCOUNT_KIND,
...
export const assetAccountKinds = [
	GENERAL_ASSET_ACCOUNT_KIND,
	LIQUID_ASSET_ACCOUNT_KIND,
	DEPRECIATIVE_ASSET_ACCOUNT_KIND,
	ITEMIZED_ASSET_ACCOUNT_KIND
...
export const temporaryAccountKinds = [
	GENERAL_EXPENSE_ACCOUNT_KIND,
	GENERAL_REVENUE_ACCOUNT_KIND,
	GENERAL_TEMPORARY_ACCOUNT_KIND,
	DIRECT_COST_ACCOUNT_KIND,
...
export const UNKNOWN_VALUATION_METHOD = "unknown"
export const WEIGHTED_AVERAGE_VALUATION_METHOD = "weighted_average"
export const FIFO_VALUATION_METHOD = "fifo"
export const LIFO_VALUATION_METHOD = "lifo"
...
export const UNKNOWN_MODIFIER_ACTION = "unknown"
...
export const BID_MODIFIER_ACTION = "bid"
export const ASK_MODIFIER_ACTION = "ask"
export const DILUTE_MODIFIER_ACTION = "dilute"
export const CONDENSE_MODIFIER_ACTION = "condense"
...
export const REAL_EMERGENT_MODIFIER_ATOM_KIND = "real_emergent"
export const REAL_DEBITEM_MODIFIER_ATOM_KIND = "real_debitem"
export const REAL_CREDITEM_MODIFIER_ATOM_KIND = "real_creditem"
