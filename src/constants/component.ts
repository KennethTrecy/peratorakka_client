...
export const FINANCIAL_ENTRY_INPUT_TOTAL_ONLY = "total_only"
export const FINANCIAL_ENTRY_INPUT_PRICE_ONLY = "price_only"
export const FINANCIAL_ENTRY_INPUT_QUANTITY_ONLY = "quantity_only"
export const FINANCIAL_ENTRY_INPUT_TOTAL_AND_QUANTITY = "total_and_quantity"
